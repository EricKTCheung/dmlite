...
extern const char* STMT_GET_REPLICA_BY_ID;
extern const char* STMT_GET_COMMENT;
extern const char* STMT_SET_GUID;
extern const char* STMT_SET_XATTR;
...
extern const char* STMT_UPDATE_USER;
extern const char* STMT_DELETE_USER;
extern const char* STMT_INSERT_GROUP;
extern const char* STMT_UPDATE_GROUP;
extern const char* STMT_DELETE_GROUP;

// Pool queries
extern const char* STMT_GET_POOLS;
extern const char* STMT_GET_POOL;
extern const char* STMT_INSERT_POOL;
extern const char* STMT_UPDATE_POOL;
extern const char* STMT_DELETE_POOL;
