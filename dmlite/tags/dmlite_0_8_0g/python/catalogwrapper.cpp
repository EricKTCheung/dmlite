 ...
 */
        ...
        // In python, it's impossible to change a string within a function and
        // have the changes propagated to the caller, since strings are immutable.
        // For this reason, we pass a StringWrapper object that wraps a string, which
        // can be changed.
