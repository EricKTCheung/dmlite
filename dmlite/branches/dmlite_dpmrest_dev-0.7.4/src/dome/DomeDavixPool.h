...
namespace dmlite {
  ...
  public:
    DavixStuff() {
      ...
      Log(Logger::Lvl1, domelogmask, domelogname, "Connection timeout is set to : " << timeout);
      ...
      Log(Logger::Lvl1, domelogmask, domelogname, "Operation timeout is set to : " << timeout);
