...
public:
   ...
   bloom_parameters()
   : minimum_size(1),
     maximum_size(std::numeric_limits<u_int64_t>::max()),
   ...
   u_int64_t projected_element_count;
   ...
   virtual bool compute_optimal_parameters()
   {
      ...
      */
      ...
      optp.table_size = static_cast<u_int64_t>(min_m);
...
public:
   ...
   inline virtual u_int64_t size() const
   {
      return table_size_;
   }
...
protected:
   ...
   u_int64_t  table_size_;
   u_int64_t  raw_table_size_;
   u_int64_t  projected_element_count_;
   unsigned int            inserted_element_count_;
   u_int64_t  random_seed_;
...
public:
   ...
   inline bool compress(const double& percentage)
   {
      ...
      u_int64_t original_table_size = size_list.back();
      u_int64_t new_table_size = static_cast<u_int64_t>((size_list.back() * (1.0 - (percentage / 100.0))));
...
private:
   ...
   std::vector<u_int64_t> size_list;
};
