...
std::string ProfilerCatalog::getImplId()
{
...
std::vector<Pool> ProfilerCatalog::getPools(void) throw (DmException)
{
...
std::vector<FileSystem> ProfilerCatalog::getPoolFilesystems(const std::string& poolname) throw (DmException)
{
