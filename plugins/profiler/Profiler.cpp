...
{
  return new ProfilerCatalog(this->nestedCatalogFactory_->createCatalog(pm));
}
...
{
  return new ProfilerPoolManager(this->nestedPoolManagerFactory_->createPoolManager(pm));
}
