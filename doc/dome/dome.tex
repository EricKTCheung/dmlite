...
\begin{itemize}
 ...
 \item pool_defsize: the default file size for new files, when their size is not known yet
 \item pool_stype: the space type for the pool. P=Permanent, V=Volatile
\end{itemize}
